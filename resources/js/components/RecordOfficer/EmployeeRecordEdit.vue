                        ...
                        <b-step-item step="1" label="Account" :clickable="isStepsClickable">
                            <div class="buttons mb-2">
                                <b-button type="is-primary" tag="a" 
                                    :href="`/record-officer/print-pds/${user.user_id}`"
...
export default {
    ...
    methods: {
        ...
        submit(){
            ...
            axios.put('/record-officer/employee/' + this.user.user_id, this.fields).then(res=>{
                if(res.data.status === 'saved'){
                    this.$buefy.dialog.alert({
                        title: "UPDATED!",
                        message: 'Profile updated successfully',
                        type: 'is-success',
                        onConfirm: () =>  window.location = '/record-officer/employee'
                    });
                }
            }).catch(err=>{
