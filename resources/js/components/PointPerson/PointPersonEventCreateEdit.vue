...
export default {
    ...
    methods:{
        ...
        submit(){
            ...
            if(this.propId > 0){
                //update
                axios.post('/point-person/events-update/' + this.propId, formData).then(res=>{
                    ...
                    if (res.data.status === 'updated'){
                        ...
                        this.$buefy.dialog.alert({
                            ...
                            onConfirm: ()=>{
                                window.location = '/point-person/events';
                            }
                        })
                ...
                //insert
                axios.post('/point-person/events', formData).then(res=>{
