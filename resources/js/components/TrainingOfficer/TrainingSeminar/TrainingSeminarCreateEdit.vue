...
export default{
    ...
    methods: {
        ...
        submit(){
            ...
            if(this.propId > 0){
                axios.post('/admin/training-seminars-update/' + this.propId, formData).then(res=>{
                    if(res.data.status === 'updated'){
                        this.$buefy.dialog.alert({
                            ...
                            onConfirm: ()=>  {
                                //this.loadSeminars()
                                window.location = '/admin/training-seminars'
                            }
                        });
                    }
                }).catch(err=>{
                ...
                axios.post('/admin/training-seminars', formData).then(res=>{
