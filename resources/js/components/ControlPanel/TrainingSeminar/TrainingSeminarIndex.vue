                ...
                <div class="column is-8-widescreen is-10-tablet">
                    <div class="box">
                        ...
                        <b-table
                            ...
                            <b-table-column field="training_seminar_id" label="ID" v-slot="props">
                                {{ props.row.training_seminar_id }}
                            </b-table-column>
                                    ...
                                    <b-tooltip label="More options" type="is-danger">
                                        <b-dropdown aria-role="list">
                                            ...
                                            <b-dropdown-item aria-role="listitem"
                                                tag="a" :href="`/training-seminar-participants/${props.row.training_seminar_id}`">Participants</b-dropdown-item>
    ...
    methods: {
        ...
        */
        loadAsyncData() {
            ...
            this.loading = true
            axios.get(`/get-training-seminars?${params}`)
                .then(({ data }) => {
                    this.data = [];
        ...
        */
        ...
        deleteSubmit(delete_id) {
            axios.delete('/training-developments/' + delete_id).then(res => {
                this.loadAsyncData();
            }).catch(err => {
        ...
        submit: function(){
            if(this.propId > 0){
                //update
                axios.put('/training-seminars/'+this.propId, this.fields).then(res=>{
                ...
                //INSERT HERE
                axios.post('/training-developments', this.fields).then(res=>{
