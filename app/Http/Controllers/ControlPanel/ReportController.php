...
class ReportController extends Controller
{
    ...
    public function index(){
        return view('control-panel.report.report-track');
    }

    public function reportInventory(){
        $items = Item::all();
        return view('control-panel.report.report-inventory')
            ->with('items', $items);
    }
    ...
    public function reportAppointment(){
        return view('control-panel.report.report-appointment');
    }
    ...
    public function printAppointment(Request $req){
        ...
        $data = DB::table('appointments as a')
            ...
            ->get();
        return view('control-panel.report.print.print-appointment')
            ->with('data', $data);
    }
